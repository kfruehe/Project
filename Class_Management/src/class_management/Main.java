...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fileAdd = new javax.swing.JMenuItem();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(bttAttendance, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
    ...
    private void bttCollectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttCollectActionPerformed
        ...
        JPanel collectPanel = new Collection();
        jSplitPane1.setRightComponent(collectPanel);
    ...
    private void bttFalcultyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttFalcultyActionPerformed
        // TODO add your handling code here:
        JPanel falcultyPanel = new Falculty();
    ...
    private void bttLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttLoginActionPerformed
        ...
        for (int i=0;i<user.size(); i++){
            if (userName.getText().equalsIgnoreCase(user.get(i)) && passWord.getText().equalsIgnoreCase(pass.get(i))){
                if(boxRemPass.isSelected()){
                    userName.setText(user.get(i));
    ...
    private javax.swing.JMenuItem fileAdd;
